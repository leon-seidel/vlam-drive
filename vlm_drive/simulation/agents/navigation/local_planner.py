...
import carla
from vlm_drive.simulation.agents.navigation.controller import VehiclePIDController
from vlm_drive.simulation.agents.tools.misc import draw_waypoints, get_speed
    ...
    def run_step(self, debug=False):
        ...
        for waypoint, _ in self._waypoints_queue:
            if len(self._waypoints_queue) - num_waypoint_removed == 1:
                min_distance = 5  # Don't remove the last waypoint until very close by
            else:
